...
# Get the credentials for the Shoes APIs
...
# Shoes API
shoes_ahub_tool = APIHubToolset(
    name="sneaker-storefront",
    description="Retrieves a list of 5 signature basketball shoes (brand and model) by calling an external API",
    apihub_resource_name=f"{API_HUB_LOCATION}/{ AHUB RESOURCE NAME}",
